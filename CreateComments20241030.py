...
class CreateComments(TkinterDnD.Tk):
    def __init__(self) -> None:
        ...
        self.config(background = 'WhiteSmoke',highlightbackground = 'WhiteSmoke',highlightcolor = 'WhiteSmoke',highlightthickness = 0)
        self.title_label =  tk.Label(self,text='File Comments Modifier',
                                     font=('Cooper Black',20),fg='Black',width=30,height=1,background = 'WhiteSmoke')
        self.title_label.place(x=-25,y=20)
        self.DropFileLabel = tk.Label(self,text = 'Drag a File Here:',background = 'WhiteSmoke',font=('Cooper Black',15),justify="left")
        ...
        self.EnterCommentsLabel = tk.Label(self,text = 'Enter File Comments Here:',background = 'WhiteSmoke',font=('Cooper Black',15))
        ...
        self.btn_start = tk.Button(self,text='[ Add Comments ]',width=15,height=2,command = self.run_add_comments, background = 'MintCream',activebackground = 'MintCream',font=('Cooper Black',10),relief = 'groove')
        self.btn_start.place(x=50,y=240)
        
        self.btn_exit = tk.Button(self,text='[ Exit ]',width=15,height=2,command = self.destroy, background = 'Pink',activebackground = 'Pink',font=('Cooper Black',10),relief = 'groove')
    ...
    def action_add_comments(self, _queue):
        ...
        def add_comment(fpath=None, comment=None):
            ...
            messagebox.showinfo(title='Finish', message='Comment Finished !')
